    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cart', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='project_app.cart')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='project_app.status')),
            ],
        ),
        migrations.AddField(
            model_name='cart',
            name='items',
            field=models.ManyToManyField(through='project_app.CartItem', to='project_app.product'),
        ),
        migrations.CreateModel(
            name='OrderDetail',
            fields=[
                ...
                ('cart_item', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='project_app.cartitem')),
